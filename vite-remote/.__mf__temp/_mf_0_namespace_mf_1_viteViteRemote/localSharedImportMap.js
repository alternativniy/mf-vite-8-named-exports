...
// Windows temporarily needs this file, https://github.com/module-federation/vite/issues/68
    ...
    const importMap = {
        ...
        "ag-grid-react": async () => {
          let pkg = await import("__mf__virtual/_mf_0_namespace_mf_1_viteViteRemote__prebuild__ag_mf_2_grid_mf_2_react__prebuild__.js");
            return pkg;
        }
      ,
        "react": async () => {
      ...
      ,
        "vue": async () => {
          let pkg = await import("__mf__virtual/_mf_0_namespace_mf_1_viteViteRemote__prebuild__vue__prebuild__.js");
            return pkg;
        }
